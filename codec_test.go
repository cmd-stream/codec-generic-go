...
import (
	...
	"github.com/cmd-stream/codec-generic-go/testdata"
...
func TestCodec(t *testing.T) {
	t.Run("Encoding should work", func(t *testing.T) {
		...
		ser := mock.NewSerializer[testdata.MyInterface, testdata.MyInterface]().RegisterMarshal(
			func(t testdata.MyInterface) ([]byte, error) {
				return wantBs, nil
			})
		codec := NewCodec(
			[]reflect.Type{
	...
	t.Run("Decoding should work", func(t *testing.T) {
		...
		ser := mock.NewSerializer[testdata.MyInterface, testdata.MyInterface]().RegisterUnmarshal(
			func(bs []byte, v testdata.MyInterface) error {
